package kp.app.its.common;

import kp.app.dal.domain.user.User;
import kp.app.dal.exceptions.BadPasswordException;
import kp.app.dal.util.DataGenerator;
import kp.app.dal.util.TestDataGenerator;
import kp.app.util.Util;
import kp.app.util.spring.Configurator;
import kp.app.util.spring.StartupProperties;
...
public class AbstractPlatformSupport {
    ...
    protected String[] getConfigurations() {
        return new String[]{
                "kp/app/its/app00105/test-server-00105.xml",
                "kp/app/its/app00200/test-server-00200.xml",
                "kp/app/its/app00205/test-server-00205.xml",
                "kp/app/its/app00270/test-server-00270.xml"
        };
    }
    ...
    protected void startServer()
        ...
        Configurator.getInstance().addConfiguration("kp/app/service/geoip-location.xml");
