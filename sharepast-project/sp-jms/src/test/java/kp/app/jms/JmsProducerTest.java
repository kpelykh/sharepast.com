...
import kp.app.jms.test.TestQueueListener;
import kp.app.jms.test.TestQueueSender;
...
public class JmsProducerTest {
        ...
        public void prepareBeforeTest()
                throws Exception {
            Configurator.getInstance().configure("kp/app/base.xml", "kp/app/jms/jms-test.xml");
        }
