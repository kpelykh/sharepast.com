package com.sharepast.commons.util.db;

import com.sharepast.commons.util.lang.DebuggingWriter;
...
// Added support to call forceReleaseLock before call to dropAll()
// Support for fully disable execution
// Preview outputs logging info into logback instead of console output
...
public class CustomSpringLiquibase implements InitializingBean, BeanNameAware, ResourceLoaderAware {
    ...
    private boolean forceReleaseLocks = false;

    public void setForceReleaseLocks(boolean forceReleaseLocks) {
        this.forceReleaseLocks = forceReleaseLocks;
    }
    ...
    private liquibase.logging.Logger log = LogFactory.getLogger(SpringLiquibase.class.getName());
    ...
    public void afterPropertiesSet() throws LiquibaseException {
        ...
        try {
            ...
            if (liquibase.listLocks().length>0 && forceReleaseLocks) {
