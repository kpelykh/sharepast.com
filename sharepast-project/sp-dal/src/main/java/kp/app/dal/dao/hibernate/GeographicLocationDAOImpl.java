...
public class GeographicLocationDAOImpl extends HibernateDao<GeographicLocationDO> implements GeographicLocationDAO {
    ...
    public Class<GeographicLocationDO> getManagedClass() {
